...
from FlexiblePurchase import FlexibleCustomer, rfq, offer, accept, standard_delivery_request, standard_delivery, express_delivery_request, express_delivery, pay, receipt
...
async def send_payment_when_ready(msg_id):
    ...
    if txn["standard_delivery"] is not None or txn["express_delivery"] is not None:
        ...
        try:
            await adapter.send(pay(**payment_kwargs))
