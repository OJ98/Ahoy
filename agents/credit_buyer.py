...
from CreditPurchase import CreditBuyer, rfq, quote, accept, reject, deliver

adapter = Adapter(CreditBuyer, CreditPurchase.protocol, config, color=COLORS[0])
...
if __name__ == "__main__":
    try:
        ...
        print("\n⏹ CreditBuyer interrupted by user")
    except SystemExit:
        print("✅ CreditBuyer shutting down gracefully")
    except Exception as e:
        print(f"❌ CreditBuyer error: {e}")
    print(
